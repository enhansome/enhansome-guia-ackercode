...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,788 | 🐛 25 | 📅 2026-09-02 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,969 | 🐛 106 | 📅 2026-09-02 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 548,802 | 🐛 646 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,373 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 209,370 | 🐛 28 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,455 | 🐛 80 | 🌐 Python | 📅 2026-09-22 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,455 | 🐛 80 | 🌐 Python | 📅 2026-09-22<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 361,718 | 🐛 126 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 17,115 | 🐛 74 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,879 | 🐛 340 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,214 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,816 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Ferramentas e técnicas de segurança web.
...
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,565 | 🐛 30 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,402 | 🐛 82 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
* [Application Security](https://github.com/paragonie/awesome-appsec#readme) ⭐ 7,063 | 🐛 42 | 🌐 PHP | 📅 2025-02-22 - Recursos e ferramentas para segurança de aplicativos.
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,575 | 🐛 82 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,640 | 🐛 5 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,561 | 🐛 4 | 📅 2026-09-14 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,450 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
...
* [DevSecOps](https://github.com/TaptuIT/awesome-devsecops#readme) ⭐ 1,735 | 🐛 45 | 📅 2024-08-02 - Integração de segurança em processos DevOps.
* [Executable Packing](https://github.com/dhondta/awesome-executable-packing#readme) ⭐ 1,622 | 🐛 1 | 📅 2026-05-31 - Técnicas para compactação de executáveis.
* [Hacking Spots](https://github.com/daviddias/awesome-hacking-locations#readme) ⭐ 1,131 | 🐛 10 | 📅 2025-08-24 - Locais para hacking ao redor do mundo.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,214 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,816 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,670 | 🐛 139 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
...
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,275 | 🐛 9 | 📅 2026-09-18 - Recursos e ferramentas para hacking de aplicações web.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,880 | 🐛 502 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,853 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,243 | 🐛 760 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
...
* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,910 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,151 | 🐛 36 | 📅 2026-09-14 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 7,186 | 🐛 40 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,514 | 🐛 5 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
* [Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling#readme) ⭐ 3,892 | 🐛 15 | 📅 2023-11-20 - Ferramentas gratuitas e abertas para desenvolvimento robótico profissional.
* [Plotters](https://github.com/beardicus/awesome-plotters#readme) ⭐ 1,457 | 🐛 5 | 📅 2025-12-03 - Máquinas de desenho controladas por computador e outros robôs de artes visuais.
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,342 | 🐛 2 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
* [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) ⭐ 1,070 | 🐛 7 | 📅 2026-08-31 - Projetos de hardware open-source.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 185,163 | 🐛 231 | 🌐 Go | 📅 2026-09-20 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 482,310 | 🐛 1,928 | 🌐 Python | 📅 2026-09-20 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,486 | 🐛 256 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,214 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 120,992 | 🐛 42 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,879 | 🐛 340 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,214 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,565 | 🐛 30 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
...
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,402 | 🐛 82 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
