...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,855 | 🐛 105 | 📅 2026-08-21
...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,771 | 🐛 24 | 📅 2024-07-16 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,855 | 🐛 105 | 📅 2026-08-21 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 543,696 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,206 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-28 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,485 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,466 | 🐛 91 | 🌐 Python | 📅 2026-08-18 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,466 | 🐛 91 | 🌐 Python | 📅 2026-08-18<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 359,915 | 🐛 126 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 16,963 | 🐛 69 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,805 | 🐛 316 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,162 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,738 | 🐛 4 | 🌐 Python | 📅 2026-08-21 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,803 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,536 | 🐛 23 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,648 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,357 | 🐛 75 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
* [Application Security](https://github.com/paragonie/awesome-appsec#readme) ⭐ 7,046 | 🐛 40 | 🌐 PHP | 📅 2025-02-22 - Recursos e ferramentas para segurança de aplicativos.
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,545 | 🐛 76 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,533 | 🐛 3 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,384 | 🐛 2 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
...
* [Lockpicking](https://github.com/fabacab/awesome-lockpicking#readme) ⭐ 1,917 | 🐛 13 | 📅 2022-06-28 - A arte de destravar uma fechadura manipulando seus componentes sem a chave.
* [DevSecOps](https://github.com/TaptuIT/awesome-devsecops#readme) ⭐ 1,720 | 🐛 39 | 📅 2024-08-02 - Integração de segurança em processos DevOps.
* [Executable Packing](https://github.com/dhondta/awesome-executable-packing#readme) ⭐ 1,614 | 🐛 1 | 📅 2026-05-31 - Técnicas para compactação de executáveis.
...
* [Hacker101](https://github.com/Hacker0x01/hacker101) ⭐ 14,518 | 🐛 3 | 🌐 SCSS | 📅 2025-02-22 - Curso gratuito sobre hacking e segurança da informação.
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,162 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,738 | 🐛 4 | 🌐 Python | 📅 2026-08-21 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,581 | 🐛 117 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,073 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,245 | 🐛 7 | 📅 2026-08-13 - Recursos e ferramentas para hacking de aplicações web.
* [Reversing](https://github.com/tylerha97/awesome-reversing) ⭐ 4,513 | 🐛 18 | 📅 2023-08-19 - Ferramentas e técnicas para engenharia reversa.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,718 | 🐛 487 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,793 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,161 | 🐛 756 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
* [Social phishing](https://github.com/UndeadSec/SocialFish) ⭐ 4,850 | 🐛 2 | 🌐 CSS | 📅 2026-05-20 - Ferramenta de phishing para engenharia social.

## 🍫 Bug bounty

* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,876 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
* [Write-ups](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,256 | 🐛 3 | 📅 2024-07-31 - Coletânea de write-ups sobre bug bounties.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,071 | 🐛 32 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 6,986 | 🐛 38 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,486 | 🐛 9 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
* [Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling#readme) ⭐ 3,885 | 🐛 13 | 📅 2023-11-20 - Ferramentas gratuitas e abertas para desenvolvimento robótico profissional.
* [Plotters](https://github.com/beardicus/awesome-plotters#readme) ⭐ 1,448 | 🐛 6 | 📅 2025-12-03 - Máquinas de desenho controladas por computador e outros robôs de artes visuais.
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,332 | 🐛 0 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
* [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) ⭐ 1,037 | 🐛 1 | 📅 2026-08-27 - Projetos de hardware open-source.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 182,552 | 🐛 219 | 🌐 Go | 📅 2026-08-28 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 472,334 | 🐛 1,806 | 🌐 Python | 📅 2026-08-26 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,179 | 🐛 257 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,162 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 972 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - Detector de quadros de desautenticação com ESP8266.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 119,254 | 🐛 40 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,805 | 🐛 316 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,162 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,536 | 🐛 23 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,802 | 🐛 2 | 🌐 Astro | 📅 2026-08-26 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,357 | 🐛 75 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,073 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
* [Awesome Tor](https://github.com/ajvb/awesome-tor) ⭐ 508 | 🐛 3 | 📅 2023-09-03 - Ferramentas e recursos para uso do Tor.
...
* [Network Analysis](https://github.com/briatte/awesome-network-analysis#readme) ⭐ 4,101 | 🐛 17 | 🌐 R | 📅 2026-08-20 - Ferramentas e técnicas para análise de redes.
* [PCAPTools](https://github.com/caesar0301/awesome-pcaptools#readme) ⭐ 3,416 | 🐛 14 | 📅 2025-09-03 - Ferramentas para análise de arquivos PCAP.
