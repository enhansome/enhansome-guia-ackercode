...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,872 | 🐛 100 | 📅 2026-06-30
...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,750 | 🐛 22 | 📅 2024-07-16 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,872 | 🐛 100 | 📅 2026-06-30 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 540,431 | 🐛 630 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,118 | 🐛 55 | 🌐 TypeScript | 📅 2026-02-28 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,068 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,612 | 🐛 80 | 🌐 Python | 📅 2026-08-16 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,612 | 🐛 80 | 🌐 Python | 📅 2026-08-16<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 359,028 | 🐛 123 | 📅 2025-08-28

## 🎢 Construir sistemas robustos que aguentam paulada

* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,394 | 🐛 606 | 🌐 Python | 📅 2026-03-20

## 🔐 Security

* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 16,891 | 🐛 68 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,757 | 🐛 307 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
...
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,760 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
...
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,613 | 🐛 2 | 🌐 Makefile | 📅 2026-08-17 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,332 | 🐛 74 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
* [Application Security](https://github.com/paragonie/awesome-appsec#readme) ⭐ 7,030 | 🐛 40 | 🌐 PHP | 📅 2025-02-22 - Recursos e ferramentas para segurança de aplicativos.
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,519 | 🐛 74 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,264 | 🐛 2 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,421 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
* [Lockpicking](https://github.com/fabacab/awesome-lockpicking#readme) ⭐ 1,914 | 🐛 13 | 📅 2022-06-28 - A arte de destravar uma fechadura manipulando seus componentes sem a chave.
* [DevSecOps](https://github.com/TaptuIT/awesome-devsecops#readme) ⭐ 1,712 | 🐛 38 | 📅 2024-08-02 - Integração de segurança em processos DevOps.
* [Executable Packing](https://github.com/dhondta/awesome-executable-packing#readme) ⭐ 1,608 | 🐛 1 | 📅 2026-05-31 - Técnicas para compactação de executáveis.
...
* [Fuzzing](https://github.com/cpuu/awesome-fuzzing#readme) ⭐ 986 | 🐛 1 | 📅 2026-07-09 - Técnicas de teste de software para encontrar vulnerabilidades.
* [Malware Persistence](https://github.com/Karneades/awesome-malware-persistence#readme) ⭐ 308 | 🐛 0 | 📅 2026-03-31 - Métodos para manter malware persistente em sistemas.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
...
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,541 | 🐛 116 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,059 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,230 | 🐛 7 | 📅 2026-08-13 - Recursos e ferramentas para hacking de aplicações web.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,634 | 🐛 481 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,772 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,129 | 🐛 752 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
...
* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,856 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
* [Write-ups](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,246 | 🐛 3 | 📅 2024-07-31 - Coletânea de write-ups sobre bug bounties.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,034 | 🐛 29 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 6,951 | 🐛 37 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,464 | 🐛 8 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
* [Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling#readme) ⭐ 3,880 | 🐛 13 | 📅 2023-11-20 - Ferramentas gratuitas e abertas para desenvolvimento robótico profissional.
...
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,322 | 🐛 0 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,294 | 🐛 212 | 🌐 Go | 📅 2026-08-16 - Recursos incríveis sobre a linguagem Go.

## 👀 Ta precisando de APIs para teste?

* [public-apis](https://github.com/public-apis/public-apis) ⭐ 462,985 | 🐛 1,684 | 🌐 Python | 📅 2026-08-17 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,111 | 🐛 256 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.
...
* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 118,496 | 🐛 39 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,757 | 🐛 307 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
...
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,744 | 🐛 2 | 🌐 Astro | 📅 2026-08-17 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,332 | 🐛 74 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,059 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
