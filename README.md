...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,210 | 🐛 106 | 📅 2026-08-21
...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,764 | 🐛 22 | 📅 2024-07-16 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,210 | 🐛 106 | 📅 2026-08-21 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 542,281 | 🐛 638 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,169 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-28 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,353 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,074 | 🐛 83 | 🌐 Python | 📅 2026-08-18 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,074 | 🐛 83 | 🌐 Python | 📅 2026-08-18<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 359,548 | 🐛 124 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 16,927 | 🐛 69 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,790 | 🐛 313 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,151 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,721 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,788 | 🐛 65 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,532 | 🐛 22 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,631 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,348 | 🐛 74 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
...
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,534 | 🐛 76 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,492 | 🐛 2 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,281 | 🐛 2 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,427 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,151 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,721 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,563 | 🐛 118 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,068 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,243 | 🐛 7 | 📅 2026-08-13 - Recursos e ferramentas para hacking de aplicações web.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,679 | 🐛 487 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
...
* [gophish](https://github.com/gophish/gophish) ⭐ 14,143 | 🐛 754 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,054 | 🐛 30 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 6,976 | 🐛 37 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,475 | 🐛 8 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
...
* [Plotters](https://github.com/beardicus/awesome-plotters#readme) ⭐ 1,443 | 🐛 6 | 📅 2025-12-03 - Máquinas de desenho controladas por computador e outros robôs de artes visuais.
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,328 | 🐛 0 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 182,035 | 🐛 215 | 🌐 Go | 📅 2026-08-21 - Recursos incríveis sobre a linguagem Go.

## 👀 Ta precisando de APIs para teste?

* [public-apis](https://github.com/public-apis/public-apis) ⭐ 469,033 | 🐛 1,753 | 🌐 Python | 📅 2026-08-19 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,161 | 🐛 257 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.
...
* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,151 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 118,882 | 🐛 40 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,790 | 🐛 313 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,151 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,532 | 🐛 22 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,787 | 🐛 5 | 🌐 Astro | 📅 2026-08-22 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,348 | 🐛 74 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,068 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
