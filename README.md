...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,781 | 🐛 24 | 📅 2026-09-02 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,987 | 🐛 106 | 📅 2026-09-02 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 545,209 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,250 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-04 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,711 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,970 | 🐛 80 | 🌐 Python | 📅 2026-09-01 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,970 | 🐛 80 | 🌐 Python | 📅 2026-09-01<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 360,356 | 🐛 126 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 17,002 | 🐛 70 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,829 | 🐛 321 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,181 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,770 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,824 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
...
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,556 | 🐛 79 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,494 | 🐛 3 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,434 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,181 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,770 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,600 | 🐛 121 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,078 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,260 | 🐛 9 | 📅 2026-09-04 - Recursos e ferramentas para hacking de aplicações web.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,768 | 🐛 494 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,812 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,181 | 🐛 759 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
...
* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,892 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
...
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 7,008 | 🐛 40 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
...
* [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) ⭐ 1,046 | 🐛 1 | 📅 2026-08-31 - Projetos de hardware open-source.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,153 | 🐛 223 | 🌐 Go | 📅 2026-09-04 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 475,263 | 🐛 1,894 | 🌐 Python | 📅 2026-09-02 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,239 | 🐛 257 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,181 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 119,690 | 🐛 40 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,829 | 🐛 321 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,181 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
...
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,839 | 🐛 1 | 🌐 Astro | 📅 2026-09-03 - Recursos sobre privacidade e segurança de dados.
...
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,078 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
