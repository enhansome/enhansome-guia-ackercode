...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,784 | 🐛 25 | 📅 2026-09-02 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,778 | 🐛 106 | 📅 2026-09-02 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 546,381 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,294 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,897 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,435 | 🐛 81 | 🌐 Python | 📅 2026-09-10 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,435 | 🐛 81 | 🌐 Python | 📅 2026-09-10<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 360,691 | 🐛 125 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 17,032 | 🐛 72 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,845 | 🐛 324 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,186 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
...
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,840 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
...
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,680 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,379 | 🐛 80 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
...
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,565 | 🐛 80 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,558 | 🐛 3 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,517 | 🐛 3 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,440 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
* [Lockpicking](https://github.com/fabacab/awesome-lockpicking#readme) ⭐ 1,925 | 🐛 13 | 📅 2022-06-28 - A arte de destravar uma fechadura manipulando seus componentes sem a chave.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,186 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
...
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,616 | 🐛 138 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,796 | 🐛 499 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
...
* [gophish](https://github.com/gophish/gophish) ⭐ 14,201 | 🐛 759 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
* [Social phishing](https://github.com/UndeadSec/SocialFish) ⭐ 4,866 | 🐛 2 | 🌐 CSS | 📅 2026-05-20 - Ferramenta de phishing para engenharia social.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,103 | 🐛 33 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 7,036 | 🐛 40 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,502 | 🐛 9 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
...
* [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) ⭐ 1,055 | 🐛 2 | 📅 2026-08-31 - Projetos de hardware open-source.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,721 | 🐛 228 | 🌐 Go | 📅 2026-09-10 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 478,546 | 🐛 1,930 | 🌐 Python | 📅 2026-09-09 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,329 | 🐛 256 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,186 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 120,092 | 🐛 42 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,845 | 🐛 324 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,186 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
...
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,862 | 🐛 4 | 🌐 Astro | 📅 2026-09-08 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,379 | 🐛 80 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
