...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,903 | 🐛 105 | 📅 2026-08-21
...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,763 | 🐛 22 | 📅 2024-07-16 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,903 | 🐛 105 | 📅 2026-08-21 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 542,061 | 🐛 636 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,155 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-28 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,320 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,005 | 🐛 83 | 🌐 Python | 📅 2026-08-18 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,005 | 🐛 83 | 🌐 Python | 📅 2026-08-18<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 359,484 | 🐛 124 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 16,920 | 🐛 68 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,786 | 🐛 314 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,148 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,718 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,781 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,526 | 🐛 22 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,627 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,346 | 🐛 74 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
* [Application Security](https://github.com/paragonie/awesome-appsec#readme) ⭐ 7,037 | 🐛 40 | 🌐 PHP | 📅 2025-02-22 - Recursos e ferramentas para segurança de aplicativos.
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,530 | 🐛 76 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,459 | 🐛 2 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,279 | 🐛 2 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,425 | 🐛 2 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
...
* [DevSecOps](https://github.com/TaptuIT/awesome-devsecops#readme) ⭐ 1,716 | 🐛 39 | 📅 2024-08-02 - Integração de segurança em processos DevOps.
* [Executable Packing](https://github.com/dhondta/awesome-executable-packing#readme) ⭐ 1,612 | 🐛 1 | 📅 2026-05-31 - Técnicas para compactação de executáveis.
...
* [Fuzzing](https://github.com/cpuu/awesome-fuzzing#readme) ⭐ 987 | 🐛 1 | 📅 2026-07-09 - Técnicas de teste de software para encontrar vulnerabilidades.
* [Malware Persistence](https://github.com/Karneades/awesome-malware-persistence#readme) ⭐ 309 | 🐛 0 | 📅 2026-03-31 - Métodos para manter malware persistente em sistemas.
...
* [Hacker101](https://github.com/Hacker0x01/hacker101) ⭐ 14,506 | 🐛 3 | 🌐 SCSS | 📅 2025-02-22 - Curso gratuito sobre hacking e segurança da informação.
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,148 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,718 | 🐛 3 | 🌐 Python | 📅 2026-08-21 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,559 | 🐛 117 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,066 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,242 | 🐛 7 | 📅 2026-08-13 - Recursos e ferramentas para hacking de aplicações web.
* [Reversing](https://github.com/tylerha97/awesome-reversing) ⭐ 4,512 | 🐛 17 | 📅 2023-08-19 - Ferramentas e técnicas para engenharia reversa.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,669 | 🐛 484 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,779 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,141 | 🐛 751 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
* [Social phishing](https://github.com/UndeadSec/SocialFish) ⭐ 4,848 | 🐛 2 | 🌐 CSS | 📅 2026-05-20 - Ferramenta de phishing para engenharia social.

## 🍫 Bug bounty

* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,865 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
* [Write-ups](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,252 | 🐛 3 | 📅 2024-07-31 - Coletânea de write-ups sobre bug bounties.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,049 | 🐛 30 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 6,972 | 🐛 37 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,474 | 🐛 8 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
...
* [Plotters](https://github.com/beardicus/awesome-plotters#readme) ⭐ 1,441 | 🐛 6 | 📅 2025-12-03 - Máquinas de desenho controladas por computador e outros robôs de artes visuais.
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,327 | 🐛 0 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,949 | 🐛 215 | 🌐 Go | 📅 2026-08-21 - Recursos incríveis sobre a linguagem Go.

## 👀 Ta precisando de APIs para teste?

* [public-apis](https://github.com/public-apis/public-apis) ⭐ 468,440 | 🐛 1,738 | 🌐 Python | 📅 2026-08-19 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,154 | 🐛 257 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.
...
* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,148 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 118,815 | 🐛 40 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,786 | 🐛 314 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,148 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,526 | 🐛 22 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,777 | 🐛 4 | 🌐 Astro | 📅 2026-08-22 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,346 | 🐛 74 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,066 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
