...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,776 | 🐛 23 | 📅 2024-07-16 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,992 | 🐛 105 | 📅 2026-08-21 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 544,570 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,233 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-01 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 208,612 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,755 | 🐛 82 | 🌐 Python | 📅 2026-09-01 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,755 | 🐛 82 | 🌐 Python | 📅 2026-09-01<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 360,177 | 🐛 126 | 📅 2025-08-28

## 🎢 Construir sistemas robustos que aguentam paulada

* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,349 | 🐛 612 | 🌐 Python | 📅 2026-03-20

## 🔐 Security

* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 16,988 | 🐛 70 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,819 | 🐛 320 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,176 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,759 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,818 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,542 | 🐛 23 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,664 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,368 | 🐛 76 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
* [Application Security](https://github.com/paragonie/awesome-appsec#readme) ⭐ 7,051 | 🐛 42 | 🌐 PHP | 📅 2025-02-22 - Recursos e ferramentas para segurança de aplicativos.
...
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,542 | 🐛 3 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
...
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,473 | 🐛 3 | 📅 2025-08-09 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
...
* [Lockpicking](https://github.com/fabacab/awesome-lockpicking#readme) ⭐ 1,922 | 🐛 13 | 📅 2022-06-28 - A arte de destravar uma fechadura manipulando seus componentes sem a chave.
...
* [Hacker101](https://github.com/Hacker0x01/hacker101) ⭐ 14,523 | 🐛 3 | 🌐 SCSS | 📅 2025-02-22 - Curso gratuito sobre hacking e segurança da informação.
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,176 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,759 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,588 | 🐛 117 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,079 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
* [Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,255 | 🐛 8 | 📅 2026-08-13 - Recursos e ferramentas para hacking de aplicações web.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,742 | 🐛 490 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,808 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,174 | 🐛 759 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
...
* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,886 | 🐛 30 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
* [Write-ups](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,262 | 🐛 3 | 📅 2024-07-31 - Coletânea de write-ups sobre bug bounties.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,091 | 🐛 34 | 📅 2026-01-05 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 6,999 | 🐛 38 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
...
* [LIDAR](https://github.com/szenergy/awesome-lidar#readme) ⭐ 1,335 | 🐛 0 | 📅 2026-03-16 - Sensores para medir distâncias iluminando o alvo com luz laser.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 182,887 | 🐛 225 | 🌐 Go | 📅 2026-09-01 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 474,178 | 🐛 1,859 | 🌐 Python | 📅 2026-08-31 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,204 | 🐛 257 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,176 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 119,504 | 🐛 40 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,819 | 🐛 320 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,176 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,542 | 🐛 23 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,819 | 🐛 2 | 🌐 Astro | 📅 2026-08-30 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,368 | 🐛 76 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,079 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
