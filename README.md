...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,896 | 🐛 107 | 📅 2026-09-02
...
Uma das nossas inspirações para este guia foi o [guia devbrasil](https://github.com/arthurspk/guiadevbrasil) ⭐ 15,786 | 🐛 25 | 📅 2026-09-02 e todos os conteúdos de [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,896 | 🐛 107 | 📅 2026-09-02 do github.
...
* [Build your own X](https://github.com/codecrafters-io/build-your-own-x) ⭐ 549,321 | 🐛 646 | 🌐 Markdown | 📅 2026-07-14 - Repositório com tutoriais para construir suas próprias versões de várias tecnologias.
...
* [Security Checklist](https://github.com/Lissy93/personal-security-checklist) ⭐ 22,376 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 - Lista de verificação pessoal para melhorar a segurança online.

## 👨‍💻 Introdução à Ciência da Computação

* [computer science](https://github.com/ossu/computer-science) ⭐ 209,427 | 🐛 28 | 🌐 HTML | 📅 2026-07-14 - Currículo aberto para aprendizado de ciência da computação.
...
* [Free programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,579 | 🐛 79 | 🌐 Python | 📅 2026-09-24 - Coletânea de livros gratuitos sobre programação.
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,579 | 🐛 79 | 🌐 Python | 📅 2026-09-24<br>

## 🗿 Dicas para passar na sua primeira entrevista de emprego em programação

* [coding-interview-university](https://github.com/jwasham/coding-interview-university/blob/main/translations/README-ptbr.md) ⭐ 361,808 | 🐛 126 | 📅 2025-08-28
...
* [Hacking](https://github.com/carpedm20/awesome-hacking#readme) ⭐ 17,124 | 🐛 74 | 📅 2024-06-02 - Recursos diversos para hacking.
* [Security](https://github.com/sbilly/awesome-security#readme) ⭐ 14,886 | 🐛 343 | 📅 2026-01-11 - Lista abrangente de recursos de segurança cibernética.
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis#readme) ⭐ 14,217 | 🐛 25 | 📅 2024-06-07 - Ferramentas e recursos para análise de malware.
* [Web Security](https://github.com/qazbnm456/awesome-web-security#readme) ⭐ 13,819 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Ferramentas e técnicas de segurança web.
* [CTF](https://github.com/apsdehal/awesome-ctf#readme) ⭐ 11,860 | 🐛 68 | 🌐 JavaScript | 📅 2024-07-22 - Capture The Flag: recursos para competições de hacking.
* [Honeypots](https://github.com/paralax/awesome-honeypots#readme) ⭐ 10,564 | 🐛 30 | 🌐 Python | 📅 2026-06-01 - Lista de armadilhas de segurança cibernética para enganar atacantes.
* [Android Security](https://github.com/ashishb/android-security-awesome#readme) ⭐ 9,706 | 🐛 1 | 🌐 Makefile | 📅 2026-09-22 - Recursos de segurança para a plataforma Android.
* [Incident Response](https://github.com/meirwah/awesome-incident-response#readme) ⭐ 9,405 | 🐛 86 | 📅 2026-07-15 - Ferramentas e recursos para resposta a incidentes de segurança.
...
* [Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam#readme) ⭐ 5,578 | 🐛 85 | 📅 2024-07-15 - Recursos para equipes de segurança defensiva.
* [Vehicle Security and Car Hacking](https://github.com/jaredthecoder/awesome-vehicle-security#readme) ⭐ 4,643 | 🐛 6 | 📅 2026-05-30 - Recursos para segurança automotiva e hacking de veículos.
* [OSCE Study Guide](https://github.com/CyberSecurityUP/OSCE-Complete-Guide) ⭐ 3,890 | 🐛 3 | 📅 2026-01-02 - Guia de estudo para a certificação Offensive Security Certified Expert.
* [Cyber Security University](https://github.com/brootware/awesome-cyber-security-university#readme) ⭐ 3,568 | 🐛 4 | 📅 2026-09-14 - Recursos educacionais gratuitos que se concentram em aprender fazendo.
* [Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security#readme) ⭐ 2,451 | 🐛 1 | 📅 2023-10-17 - Segurança para dispositivos IoT e sistemas embarcados.
...
* [DevSecOps](https://github.com/TaptuIT/awesome-devsecops#readme) ⭐ 1,737 | 🐛 46 | 📅 2024-08-02 - Integração de segurança em processos DevOps.
...
* [Analise de Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,217 | 🐛 25 | 📅 2024-06-07 - Ferramentas e técnicas para análise de malware.
* [Web Hacking Security](https://github.com/qazbnm456/awesome-web-security/) ⭐ 13,819 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Ferramentas para segurança em aplicações web.
* [Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,673 | 🐛 140 | 📅 2026-05-31 - Coleta e análise de dados para identificar ameaças de segurança.
* [Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,100 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para simulação de ataques.
...
* [Reversing](https://github.com/tylerha97/awesome-reversing) ⭐ 4,521 | 🐛 18 | 📅 2023-08-19 - Ferramentas e técnicas para engenharia reversa.
...
* [zphisher](https://github.com/htr-tech/zphisher) ⭐ 16,888 | 🐛 502 | 🌐 HTML | 📅 2024-08-21 - Ferramenta automatizada para ataques de phishing.
* [Wifi Phishing](https://github.com/wifiphisher/wifiphisher) ⭐ 14,850 | 🐛 353 | 🌐 Python | 📅 2026-05-22 - Ferramenta para realizar ataques de phishing em redes WiFi.
* [gophish](https://github.com/gophish/gophish) ⭐ 14,248 | 🐛 761 | 🌐 Go | 📅 2024-09-23 - Ferramenta de código aberto para criar campanhas de phishing.
* [Social phishing](https://github.com/UndeadSec/SocialFish) ⭐ 4,887 | 🐛 2 | 🌐 CSS | 📅 2026-05-20 - Ferramenta de phishing para engenharia social.

## 🍫 Bug bounty

* [Programs and write-ups](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,911 | 🐛 31 | 📅 2026-03-07 - Recursos para programas de bug bounty e write-ups.
...
* [Electronics](https://github.com/kitspace/awesome-electronics#readme) ⭐ 8,156 | 🐛 37 | 📅 2026-09-14 - Recursos para engenheiros eletrônicos e amadores.
* [Robotics](https://github.com/Kiloreux/awesome-robotics#readme) ⭐ 7,193 | 🐛 40 | 📅 2024-09-22 - Recursos incríveis sobre robótica.
* [Internet of Things](https://github.com/HQarroum/awesome-iot#readme) ⭐ 4,515 | 🐛 5 | 📅 2026-08-10 - Recursos para Internet das Coisas (IoT).
* [Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling#readme) ⭐ 3,893 | 🐛 15 | 📅 2023-11-20 - Ferramentas gratuitas e abertas para desenvolvimento robótico profissional.
...
* [Open Hardware](https://github.com/delftopenhardware/awesome-open-hardware#readme) ⭐ 1,071 | 🐛 7 | 📅 2026-08-31 - Projetos de hardware open-source.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 185,416 | 🐛 229 | 🌐 Go | 📅 2026-09-24 - Recursos incríveis sobre a linguagem Go.
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 482,862 | 🐛 1,947 | 🌐 Python | 📅 2026-09-24 - Lista de APIs públicas gratuitas para testes e desenvolvimento.

## 🤔 The Art of Command Line

* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,495 | 🐛 256 | 📅 2024-06-25 - Guia completo para uso avançado da linha de comando.

## 📉 Domain name Research / Analysis / Reputation

* [Domain analysis list](https://github.com/rshipp/awesome-malware-analysis/#domain-analysis) ⭐ 14,217 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de domínios.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 121,119 | 🐛 43 | 📅 2026-07-26 - Recursos diversos sobre hacking.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,886 | 🐛 343 | 📅 2026-01-11 - Lista abrangente de recursos de segurança.
* [Awesome Malware](https://github.com/rshipp/awesome-malware-analysis/) ⭐ 14,217 | 🐛 25 | 📅 2024-06-07 - Recursos para análise de malware.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,564 | 🐛 30 | 🌐 Python | 📅 2026-06-01 - Recursos sobre honeypots de segurança.
* [Awesome Privacy](https://github.com/Lissy93/awesome-privacy) ⭐ 9,897 | 🐛 2 | 🌐 Astro | 📅 2026-09-24 - Recursos sobre privacidade e segurança de dados.
* [Reposta a incidentes](https://github.com/meirwah/awesome-incident-response/) ⭐ 9,405 | 🐛 86 | 📅 2026-07-15 - Ferramentas para resposta a incidentes.
* [Awesome Red Team](https://github.com/yeyintminthuhtut/Awesome-Red-Teaming) ⭐ 8,100 | 🐛 19 | 📅 2023-12-28 - Ferramentas e técnicas para equipes Red Team.
